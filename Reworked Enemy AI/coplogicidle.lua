...
function CopLogicIdle._chk_relocate(data)
	if data.objective and data.objective.type == "follow" then
		...
		if data.is_tied and data.objective.lose_track_dis and data.objective.lose_track_dis * data.objective.lose_track_dis < mvec3_dis_sq(data.m_pos, data.objective.follow_unit:movement():m_pos()) then
